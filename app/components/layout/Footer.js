      ...
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 font-medium text-sm leading-7">
              Website chính thức và duy nhất của FashionFusion. Hiện tại chúng
              mình chỉ nhận đơn hàng trên website chứ không nhận bất kỳ nơi nào
              khác nhé!
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium text-sm list-disc pl-4">
              <li className="mb-4">
                <a href="/profile/faq" className="hover:underline">
                  Giới thiệu
                </a>
              </li>
              <li className="mb-4">
        ...
        <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
            © 2024 <a href="https://flowbite.com/">FashionFusion</a>. All Rights
            Reserved.
          </span>
