...
const products = [
  {
    image:
      "https://mcdn2.coolmate.me/cdn-cgi/image/width=672,height=990,quality=85/uploads/February2024/vunarttrai11_19.jpg",
    hoverImage:
  ...
  {
    image:
      "https://mcdn2.coolmate.me/cdn-cgi/image/width=672,height=990,quality=85/uploads/February2024/vunartqyay2_72.jpg",
  ...
  {
    image:
      "https://mcdn2.coolmate.me/cdn-cgi/image/width=672,height=990,quality=85/uploads/February2024/oantuti1_2.jpg",
    hoverImage:
...
const RunningClothesData = [
  {
    image:
      "https://media2.coolmate.me/cdn-cgi/image/width=672,height=990,quality=85,format=auto/uploads/January2024/23CMAW.AT003.3D.2.jpg",
    hoverImage:
  ...
  {
    image:
      "https://media2.coolmate.me/cdn-cgi/image/width=672…format=auto/uploads/March2024/jungle3dthumb.1.jpg",
    hoverImage:
  ...
  {
    image:
      "https://media2.coolmate.me/cdn-cgi/image/width=672…lity=85,format=auto/uploads/March2023/ss6.917.jpg",
    hoverImage:
  ...
  {
    image:
      "https://media2.coolmate.me/cdn-cgi/image/width=672…to/uploads/March2023/thumb_quan_promax_den_97.jpg",
    hoverImage:
...
const TShirtMenData = [
  {
    image:
      "https://media2.coolmate.me/cdn-cgi/image/width=672…ty=85,format=auto/uploads/March2023/blue_copy.jpg",
    hoverImage:
  ...
  {
    image:
      "https://media2.coolmate.me/cdn-cgi/image/width=672…=auto/uploads/March2024/3dchaybov2esenv2.1_12.jpg",
    hoverImage:
  ...
  {
    image:
      "https://media2.coolmate.me/cdn-cgi/image/width=672…ty=85,format=auto/uploads/January2022/2recyw2.jpg",
    hoverImage:
  ...
  {
    image:
      "https://mcdn2.coolmate.me/cdn-cgi/image/quality=80,format=auto/uploads/October2023/denn3-(2)_copys_62.jpg",
    hoverImage:
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <div className="text-primary my-10 flex gap-2 font-semibold">
        ...
        <p className="text-2xl">
          HÀNG <span className="text-red-500 text-2xl font-bold">HOT</span> GIÁ
          XỊN
        </p>
      </div>
      ...
      <div className="relative">
        ...
        <div className="flex flex-col gap-4 absolute top-1/2 left-5 md:left-20 transform -translate-y-1/2">
          ...
          <div className="flex w-32 text-xs md:text-base md:w-48 rounded-3xl items-center bg-blue-500 hover:bg-blue-600 text-white">
            ...
            <i className="ri-arrow-right-circle-line text-base md:text-xl"></i>
          </div>
        </div>
      </div>
